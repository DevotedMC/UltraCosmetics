...
public class ParticleEffectType extends CosmeticMatType<ParticleEffect> {
    ...
    public static final ParticleEffectType T1FLAME = new ParticleEffectType("ultracosmetics.particleeffects.t1flame", "T1Flame", 1, Particles.LAVA, Material.BLAZE_POWDER, (byte) 0, ParticleEffectT1Flame.class, "&7&oT1!!");
